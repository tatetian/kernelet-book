...
Four assumptions of the Design chapter break under a Linux host, and one of them changes how the kernel proper reaches its tenant's memory. They are on the [next page](not-as-assumed.md).
