...
> **To be written.** The Design chapter, and after it the background facts, the principles of API virtualization, the OSTD API taxonomy, the implementation, the evaluation and the limitations. The earlier versions of those chapters were removed on purpose and will be rewritten.
